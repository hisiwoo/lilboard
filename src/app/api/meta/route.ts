...
import { BASE_PRICE, CANVAS_H, CANVAS_W, FREE_COOLDOWN_S, FREE_MODE, MAX_OVERWRITE_MULT, MAX_PIXELS_PER_ORDER, PALETTE, ROUND_HOURS, SPLIT, TOKEN } from "@/lib/config";
...
export async function GET() {
  ...
  return json({
    ...
    freeMode: FREE_MODE, freeCooldown: FREE_COOLDOWN_S, roundHours: ROUND_HOURS, split: SPLIT,
